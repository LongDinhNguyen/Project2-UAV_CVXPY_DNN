...
bandwidth = 1 #MHz
height = 200 #m
# eta = 0.5 #EH efficiency   # power_UAV = 5000   # power_cir_UAV = 4000
atg_a = 11.95
atg_b = 0.136
...
max_uav_to_d2d_gains = sp.zeros(max_num_d2d_pairs)
...
for i in xrange(max_num_d2d_pairs):
    max_uav_to_d2d_gains[i] = sp.divide(uav.loss_to_pair(d2d_pairs[i], atg_a, atg_b), noise_variance)
...
sp.savez('x_chan_model', uav=max_uav_to_d2d_gains, d2d=max_d2d_to_d2d_gains)
